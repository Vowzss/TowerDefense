...
void LevelEditor::Start()
{
    ...
    mCurrentFile = "Resources/Saves/map1.bin";
    Load();
    for (int i = 0; i < gridWidth; i++)
    {
        for (int j = 0; j < gridHeight; j++)
...
void LevelEditor::InitNavigationButton()
{
    ...
    [](Button *self)
    {
        ((LevelEditor*)self->mUserPtr)->mCurrentFile = "Resources/Saves/map1.bin";
    ...
    [](Button *self)
    {
        ((LevelEditor*)self->mUserPtr)->mCurrentFile = "Resources/Saves/map2.bin";
        ((LevelEditor*)self->mUserPtr)->Load();
    },
    ...
    [](Button *self)
    {
        ((LevelEditor*)self->mUserPtr)->mCurrentFile = "Resources/Saves/map3.bin";
        ((LevelEditor*)self->mUserPtr)->Load();
    },
    ...
    [](Button *self)
    {
        ((LevelEditor*)self->mUserPtr)->mCurrentFile = "Resources/Saves/map4.bin";
        ((LevelEditor*)self->mUserPtr)->Load();
    },
    ...
    [](Button *self)
    {
        ((LevelEditor*)self->mUserPtr)->mCurrentFile = "Resources/Saves/map5.bin";
        ((LevelEditor*)self->mUserPtr)->Load();
    },
    ...
    [](Button *self)
    {
        ((LevelEditor*)self->mUserPtr)->mCurrentFile = "Resources/Saves/map6.bin";
        ((LevelEditor*)self->mUserPtr)->Load();
    },
    ...
    [](Button *self)
    {
        ((LevelEditor*)self->mUserPtr)->mCurrentFile = "Resources/Saves/map7.bin";
        ((LevelEditor*)self->mUserPtr)->Load();
    },
    ...
    [](Button *self)
    {
        ((LevelEditor*)self->mUserPtr)->mCurrentFile = "Resources/Saves/map8.bin";
        ((LevelEditor*)self->mUserPtr)->Load();
    },
    ...
    [](Button *self)
    {
        ((LevelEditor*)self->mUserPtr)->mCurrentFile = "Resources/Saves/map9.bin";
        ((LevelEditor*)self->mUserPtr)->Load();
    },
    ...
    [](Button *self)
    {
        ((LevelEditor*)self->mUserPtr)->mCurrentFile = "Resources/Saves/map10.bin";
        ((LevelEditor*)self->mUserPtr)->Load();
    },
    ...
    [](Button *self)
    {
        ((LevelEditor*)self->mUserPtr)->mCurrentFile = "Resources/Saves/map11.bin";
        ((LevelEditor*)self->mUserPtr)->Load();
    },
    ...
    [](Button *self)
    {
        ((LevelEditor*)self->mUserPtr)->mCurrentFile = "Resources/Saves/map12.bin";
        ((LevelEditor*)self->mUserPtr)->Load();
    },
